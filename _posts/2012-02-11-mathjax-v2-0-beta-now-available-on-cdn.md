...
While the code is complete, we are still working on the documentation.  Many of the new features are new extensions that you can add to your configuration; see [http://cdn.mathjax.org/mathjax/2.0-latest/unpacked/extensions/](http://cdn.mathjax.org/mathjax/2.0-latest/unpacked/extensions/) and its TeX and HTML-CSS subdirectories.  The comments in the extension files should tell you what they do and how to configure them.  Other features are controlled by new configuration parameters, which you will find in [http://cdn.mathjax.org/mathjax/2.0-latest/config/default.js](http://cdn.mathjax.org/mathjax/2.0-latest/config/default.js) so look there for some information as well.  There are a number of new combined configuration files that include the new input and output processors in different configurations, so check them out at [http://cdn.mathjax.org/mathjax/2.0-latest/config](http://cdn.mathjax.org/mathjax/2.0-latest/config).
