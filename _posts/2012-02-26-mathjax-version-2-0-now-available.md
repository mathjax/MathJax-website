...
See [http://www.mathjax.org/docs/2.0/whats-new-2.0.html](http://www.mathjax.org/docs/2.0/whats-new-2.0.html) for details about the changes in v2.0, and some caveats about the effect of these changes on existing sites.
